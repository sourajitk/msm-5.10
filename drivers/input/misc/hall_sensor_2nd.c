...
//	}
	...
	if(ReportFlg == 1){
		input_report_switch(hall_sensor_dev->hall_indev, SW_HALL2, !hall_sensor_dev->status);
...
static int init_input_event(void)
{
	...
	input_set_capability(hall_sensor_dev->hall_indev, EV_SW, SW_HALL2);
