...
#define PROC_MOTOR_DOOR_STATE   "driver/motor_door_state"
#define PROC_MOTOR_DOOR_STATE_FAC   "driver/motor_door_state_fac"
...
static void create_motor_proc_files_factory(void)
{
	...
	if(!has_created)
	{
		...
		create_proc_file(PROC_MOTOR_DOOR_STATE, &motor_door_state_fops);
		create_proc_file(PROC_MOTOR_DOOR_STATE_FAC, &motor_door_state_fac_fops);
